...
const DriverLogin = React.lazy(() => import('./views/pages/Driver/Login/Login'))
    ...
    return (
      <Router>
        <Suspense fallback={loading}>
          <AuthProvider>
            <Routes>
              <Route exact path="/driver/login" name="Driver Login" element={<DriverLogin />} />
              ...
              <Route path="/customer/*" name="Customer Pages" element={<ProtectedRoute guard={"customer"} children={<CustomerLayout />} />} />
              <Route path="/driver/*" name="Driver Pages" element={<ProtectedRoute guard={"driver"} children={<DriverLayout />} />} />
